    ...
    <div className={`bg-[${colorPrimary}] w-full h-16 absolute top-0`}>
     ...
     <Wrapper className='flex h-full  items-center justify-center  md:pl-0  '>
        <div className='grid grid-cols-1  md:grid-cols-12 w-full  '>
          ...
          <picture>
            <img src={parametros.logo} alt="backgroundLogin" className=" w-9/12 h-9/12  2xl:w-10/12 2xl:h-10/12 mx-20 2xl:mx-16 object-cover" />
          </picture>
          </div>
          <div id="Formulario" className={ `lg:col-span-4 2xl:col-span-3 border-[1px] rounded-md border-[${colorPrimary}] md:mt-10 2xl:mt-0`}>                      
           <div className="mt-10 mb-7"> 
            ...
            <div className='flex flex-col items-center text-center justify-around pb-10 mt-10'>
              <p className='text-sm opacity-75 text-primaryText-50'>
                {`© ${new Date().getFullYear()} Copyright ${parametros?.nombreApp} - Todos los derechos reservados`}
              </p>
            </div>
